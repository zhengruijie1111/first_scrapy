...
class DanjiyouxiSpider(scrapy.Spider):
    name="danjiyouxi"
    ...
    def start_requests(self):
        ...
        for i in range(3, 116):
            url = "http://www.friok.com/category/danjiyx/page/" + str(i)
            headers = {
                "refer": "http://www.friok.com/category/danjiyx/page/"+str(i),
                'User-Agent': "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.132 Safari/537.36"
            }
...
filename = "/Users/zhengruijie/Desktop/danjiyouxi.xlsx"
def readline():
