...
class DianyingSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for i in range(5, 180):
            url = "http://www.friok.com/category/gaoq/page/" + str(i)
            headers = {
                "refer": "http://www.friok.com/category/gaoq/page/"+str(i),
                'User-Agent': "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.132 Safari/537.36"
            }
...
filename = "/Users/zhengruijie/Desktop/gaoqingdianying.xlsx"
def readline():
