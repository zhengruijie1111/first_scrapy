...
class DianYingZiYuanSpider(scrapy.Spider):
    name="dianyingziyuan"
    ...
    def start_requests(self):
        ...
        # )
        for i in range(1, 2):
            url = "http://www.friok.com/category/dyzy/page/" + str(i)
            headers = {
                "refer": "http://www.friok.com/category/dyzy/page/"+str(i),
                'User-Agent': "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.132 Safari/537.36"
            }

            # global second_curren
            # second_current = url
            # time.sleep(2)
            time.sleep(0.5)
            yield scrapy.Request(
...
filename = "/Users/zhengruijie/Desktop/dianyingziyuan.xlsx"
def readline():
