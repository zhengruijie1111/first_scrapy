...
class DianShiZiYuanSpider(scrapy.Spider):
    name="dianshiziyuan"
    ...
    def start_requests(self):
        ...
        # )
        for i in range(3, 64):
            url = "http://www.friok.com/category/dsjzy/page/" + str(i)
            headers = {
                "refer": "http://www.friok.com/category/dsjzy/page/"+str(i),
                'User-Agent': "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.132 Safari/537.36"
            }
...
filename = "/Users/zhengruijie/Desktop/dianshiziyuan.xlsx"
def readline():
