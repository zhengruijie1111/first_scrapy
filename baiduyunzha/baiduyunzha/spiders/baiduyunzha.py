...
class BaiDuYunZhaSpider(scrapy.Spider):
    name="baiduyunzha"
    ...
    def start_requests(self):
        ...
        # )
        for i in range(3, 8):
            url = "http://www.friok.com/category/bdyz/page/" + str(i)
            headers = {
                "refer": "http://www.friok.com/category/bdyz/page/"+str(i),
                'User-Agent': "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.132 Safari/537.36"
            }
...
filename = "/Users/zhengruijie/Desktop/baiduyunzha.xlsx"
def readline():
