...
class RanJianZiYuanSpider(scrapy.Spider):
    name="ruanjianziyuan"
    ...
    def start_requests(self):
        ...
        # )
        for i in range(7, 10):
            url = "http://www.friok.com/category/rjzy/page/" + str(i)
            headers = {
                "refer": "http://www.friok.com/category/rjzy/page/"+str(i),
                'User-Agent': "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.132 Safari/537.36"
            }
...
filename = "/Users/zhengruijie/Desktop/ruanjianziyuan.xlsx"
def readline():
